...
var Swiper = function (options) {
    ...
    if(this.autoPlay){
        if(this.autoPlay==true){
            this.auto(1000)
        }else if(typeof this.autoPlay=="number"){
...
Swiper.prototype = {
    ...
    addEvent: function () {
        ...
        this.container.addEventListener('touchstart', startFn.bind(this));
    ...
    go:function (index) {
        ...
        this.swiperWrap.classList.add('tst');
    ...
    auto:function(time){
        ...
        this.time=setInterval(function(){
            ...
            if(that.index>that.length-1){that.index=that.length-1;return}
            that.go(that.index)
        },time)
